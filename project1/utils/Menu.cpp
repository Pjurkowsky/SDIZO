...
void Menu::listFunctions(int i, int j)
{
    ...
    case 9:
    {
        ...
        while (file >> x)
        {
            auto fp = std::bind(&List::addFront, list, x);
            time += timer.getElapsedTime(fp);
        }
        file.close();
        std::cout << time << "\n";
        waitForUser();
...
void Menu::testModeFunctions(int j)
{
    ...
    case 2:
    {
        ...
        testMode(listPush, treePush, true);
        break;
    }
    case 3:
    {
        ...
        testMode(listFind, treeFind, true);
        break;
    }
    case 4:
    {
        ...
        ListPop listPop = &List::removeFromIndex;
        TreePop treePop = &Tree::pop;

        //  testMode(listPop, treePop, false);
        break;
    }
